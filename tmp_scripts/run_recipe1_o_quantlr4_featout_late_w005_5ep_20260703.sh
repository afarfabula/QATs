...
EXP=recipe1_o_quantlr4_featout_late_w005_5ep_20260703
...
PYTHONUNBUFFERED=1 python3 "$QATS/qat_launch.py" \
  ...
  --devices 0,1,2,3,4,5,6,7 --nproc-per-node 8 --master-port 30331 --model-type swin \
  ...
  --teacher-feature-output-warmup-epochs 1 \
