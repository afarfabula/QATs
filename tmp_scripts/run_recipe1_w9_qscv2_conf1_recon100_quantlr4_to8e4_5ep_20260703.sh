...
EXP=recipe1_w9_qscv2_conf1_recon100_quantlr4_to8e4_5ep_20260703
...
PYTHONUNBUFFERED=1 python3 "$QATS/qat_launch.py" \
  ...
  --devices 0,1,2,3,4,5,6,7 --nproc-per-node 8 --master-port 30349 --model-type swin \
  ...
  --pre-qat-feature-recon-confidence-power 1.0 \
