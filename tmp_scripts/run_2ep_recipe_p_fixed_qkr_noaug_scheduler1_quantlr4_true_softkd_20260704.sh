...
EXP="${EXP:-recipe2ep_p_fixed_qkr_noaug_scheduler1_quantlr4_true_softkd_20260704}"
...
{
  echo "===== 2ep recipe P fixed-QKR no-aug scheduler1 quantlr4 true pure-soft-KD $(date '+%F %T') ====="
  echo "QATS=${QATS}"
  echo "DATA=${DATA}"
  echo "OUT=${OUT}/${EXP}"
