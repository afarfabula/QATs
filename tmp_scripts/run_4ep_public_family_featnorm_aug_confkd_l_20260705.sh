...
EXP="${EXP:-recipe4ep_l_featnorm_aug_confkd_fixed_qkr_softkd_t275_20260705}"
...
{
  echo "===== 4ep recipe L public-style W4A4-family feature-output + augmented teacher distill + confidence KD fixed-QKR soft-KD T=2.75 $(date '+%F %T') ====="
  echo "QATS=${QATS}"
  echo "DATA=${DATA}"
  echo "OUT=${OUT}/${EXP}"
