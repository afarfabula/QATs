...
EXP="${EXP:-recipe_resume10_lateqdrop_prerecon_gate_20260707}"
...
PRE_QAT_FEATURE_RECON_QDROP_PROB="${PRE_QAT_FEATURE_RECON_QDROP_PROB:-0.5}"
PRE_QAT_FEATURE_RECON_QDROP_LAYERS="${PRE_QAT_FEATURE_RECON_QDROP_LAYERS:-features.5.5,features.7.1}"
...
cmd=(
  ...
  --pre-qat-feature-recon-qdrop-prob "${PRE_QAT_FEATURE_RECON_QDROP_PROB}"
  --pre-qat-feature-recon-qdrop-layers "${PRE_QAT_FEATURE_RECON_QDROP_LAYERS}"
...
{
  echo "===== Resume10 late-layer QDrop pre-QAT feature recon gate $(date '+%F %T') ====="
  echo "QATS=${QATS}"
  echo "DATA=${DATA}"
  echo "OUT=${OUT}/${EXP}"
  echo "RESUME=${RESUME}"
  ...
  echo "PRE_QAT_FEATURE_RECON_QDROP_PROB=${PRE_QAT_FEATURE_RECON_QDROP_PROB}"
  echo "PRE_QAT_FEATURE_RECON_QDROP_LAYERS=${PRE_QAT_FEATURE_RECON_QDROP_LAYERS}"
