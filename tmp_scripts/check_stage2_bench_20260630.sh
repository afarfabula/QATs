...
echo METRICS
[ -f "${LOG}" ] && grep -E "Enabled EMA refmodel|Effective batch|Train: 50|TrainSummary|Stopped early|RefAttnKL|RuntimeError|CUDA out|Traceback|Killed" "${LOG}" | tail -80 || true
echo CKPTS
