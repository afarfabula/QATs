...
EXP=swin_t_w4a4_stage2_full_dynamic_customtop5_teacherattn_lr5e6_noema_from50_to51_bsz128_kd_20260701
LOG=/tmp/${EXP}.log
...
python3 /mlx_devbox/users/quyanyi/playground/QATs/qat_launch.py \
  ...
  --devices 0,1,2,3,4,5,6,7 --nproc-per-node 8 --master-port 30127 \
  ...
  --teacher-attn-kl-weight 0.0001 --teacher-attn-kl-warmup-epochs 50 \
