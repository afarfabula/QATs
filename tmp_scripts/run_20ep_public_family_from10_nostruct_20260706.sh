...
EXP="${EXP:-recipe20ep_from10_nostruct_featnorm_softkd_20260706}"
...
{
  echo "===== 20ep continuation from epoch10 80.364 public-style W4A4-family no-structure baseline $(date '+%F %T') ====="
  echo "QATS=${QATS}"
  echo "DATA=${DATA}"
  echo "OUT=${OUT}/${EXP}"
  echo "RESUME=${RESUME}"
