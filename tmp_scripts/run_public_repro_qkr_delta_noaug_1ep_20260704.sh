...
EXP="${EXP:-qkr_delta_noaug_1ep_20260704}"
...
{
  echo "===== QKR delta no-aug 1epoch gate $(date '+%F %T') ====="
  echo "Purpose: isolate QKR by matching the non-QKR successful gate except for --qk-reparam."
  echo "QATS=${QATS}"
  echo "DATA=${DATA}"
  echo "OUT=${OUT}/${EXP}"
