...
EXP=swin_t_w4a4_stage2_c16_dynamic_customtop5_from50_to60_bsz128_kd_noema_20260701
LOG=/tmp/${EXP}.log
OUT=/tmp/qats_stage2_outputs/stage2_50to60_diagnostic_20260701
...
python3 /mlx_devbox/users/quyanyi/playground/QATs/qat_launch.py \
  ...
  --devices 0,1,2,3,4,5,6,7 --nproc-per-node 8 --master-port 30129 \
  ...
  --resume "${CKPT}" --no-resume-opt --epochs 60 --start-epoch 50 --scheduler-epochs 100 \
