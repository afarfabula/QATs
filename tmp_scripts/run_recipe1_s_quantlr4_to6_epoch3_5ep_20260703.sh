...
EXP=recipe1_s_quantlr4_to6_epoch3_5ep_20260703
...
PYTHONUNBUFFERED=1 python3 "$QATS/qat_launch.py" \
  ...
  --devices 0,1,2,3,4,5,6,7 --nproc-per-node 8 --master-port 30335 --model-type swin \
  ...
  --quant-lr-multiplier-epoch-overrides 3:6,4:6 \
