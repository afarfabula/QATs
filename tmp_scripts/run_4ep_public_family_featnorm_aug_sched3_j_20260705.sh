...
EXP="${EXP:-recipe4ep_j_featnorm_aug_sched3_fixed_qkr_softkd_t275_20260705}"
...
{
  echo "===== 4ep recipe J public-style W4A4-family feature-output + augmented teacher distill scheduler3 fixed-QKR soft-KD T=2.75 $(date '+%F %T') ====="
  echo "QATS=${QATS}"
  echo "DATA=${DATA}"
  echo "OUT=${OUT}/${EXP}"
