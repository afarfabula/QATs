...
EXP=swin_t_w4a4_stage2_c29_stage1_nokl_lr1e5_from50_to51_20260701
LOG=/tmp/${EXP}.log
OUT=/tmp/qats_stage2_outputs/stage2_50to51_stage1_nokl_20260701
...
python3 /mlx_devbox/users/quyanyi/playground/QATs/qat_launch.py \
  ...
  --devices 0,1,2,3,4,5,6,7 --nproc-per-node 8 --master-port 30136 \
