...
EXP="${EXP:-recipe_resume10_actpercentile_prerecon_gate_20260707}"
...
MASTER_PORT="${MASTER_PORT:-30563}"
EPOCHS="${EPOCHS:-3}"
SCHEDULER_EPOCHS="${SCHEDULER_EPOCHS:-3}"
LR="${LR:-1.5e-5}"
MIN_LR="${MIN_LR:-5e-6}"
QUANT_LR_MULTIPLIER="${QUANT_LR_MULTIPLIER:-2}"
PRE_QAT_ACT_PERCENTILE_CALIB_BATCHES="${PRE_QAT_ACT_PERCENTILE_CALIB_BATCHES:-16}"
PRE_QAT_ACT_PERCENTILE_CALIB_LAYERS="${PRE_QAT_ACT_PERCENTILE_CALIB_LAYERS:-features.5.5,features.7.1}"
PRE_QAT_ACT_PERCENTILE_CALIB_PERCENTILE="${PRE_QAT_ACT_PERCENTILE_CALIB_PERCENTILE:-0.999}"
PRE_QAT_ACT_PERCENTILE_CALIB_BLEND="${PRE_QAT_ACT_PERCENTILE_CALIB_BLEND:-0.5}"
...
cmd=(
  ...
  --pre-qat-act-percentile-calib-batches "${PRE_QAT_ACT_PERCENTILE_CALIB_BATCHES}"
  --pre-qat-act-percentile-calib-layers "${PRE_QAT_ACT_PERCENTILE_CALIB_LAYERS}"
  --pre-qat-act-percentile-calib-percentile "${PRE_QAT_ACT_PERCENTILE_CALIB_PERCENTILE}"
  --pre-qat-act-percentile-calib-blend "${PRE_QAT_ACT_PERCENTILE_CALIB_BLEND}"
...
{
  echo "===== Resume10 activation percentile calibration + pre-QAT feature recon gate $(date '+%F %T') ====="
  echo "QATS=${QATS}"
  echo "DATA=${DATA}"
  echo "OUT=${OUT}/${EXP}"
  echo "RESUME=${RESUME}"
  ...
  echo "PRE_QAT_ACT_PERCENTILE_CALIB_BATCHES=${PRE_QAT_ACT_PERCENTILE_CALIB_BATCHES}"
  echo "PRE_QAT_ACT_PERCENTILE_CALIB_LAYERS=${PRE_QAT_ACT_PERCENTILE_CALIB_LAYERS}"
  echo "PRE_QAT_ACT_PERCENTILE_CALIB_PERCENTILE=${PRE_QAT_ACT_PERCENTILE_CALIB_PERCENTILE}"
  echo "PRE_QAT_ACT_PERCENTILE_CALIB_BLEND=${PRE_QAT_ACT_PERCENTILE_CALIB_BLEND}"
