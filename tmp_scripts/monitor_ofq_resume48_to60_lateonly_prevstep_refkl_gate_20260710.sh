...
EXP="${EXP:-ofq_resume48_to60_lateonly_prevstep_refkl_gate_20260710}"
...
STATUS="${STATUS:-${DOC_DIR}/ofq_resume48_to60_lateonly_prevstep_refkl_gate_status_20260710.tsv}"
REF_STATUS="${REF_STATUS:-${DOC_DIR}/ofq_resume48_to60_lateonly_prevstep_refkl_gate_refw_20260710.tsv}"
SUMMARY="${SUMMARY:-${DOC_DIR}/ofq_resume48_to60_lateonly_prevstep_refkl_gate_monitor_summary_20260710.txt}"
