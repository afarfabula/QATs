...
EXP=recipe1_w7_seqfeatrecon50x2_quantlr4_to8e4_5ep_20260703
...
PYTHONUNBUFFERED=1 python3 "$QATS/qat_launch.py" \
  ...
  --devices 0,1,2,3,4,5,6,7 --nproc-per-node 8 --master-port 30345 --model-type swin \
  ...
  --pre-qat-seq-feature-recon-updates 50 \
  --pre-qat-seq-feature-recon-layers features.5.5,features.7.1 \
