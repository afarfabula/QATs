...
EXP="${EXP:-recipe2ep_f_fixed_qkr_noaug_scheduler1_quantlr8_20260704}"
...
{
  echo "===== 2ep recipe F fixed-QKR no-aug scheduler1 quantlr8 $(date '+%F %T') ====="
  echo "QATS=${QATS}"
  echo "DATA=${DATA}"
  echo "OUT=${OUT}/${EXP}"
