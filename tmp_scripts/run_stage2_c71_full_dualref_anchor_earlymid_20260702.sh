...
EXP=swin_t_w4a4_stage2_c71_full_dualref_anchor_earlymid_from50_to51_20260702
LOG=/tmp/${EXP}.log
...
python3 /mlx_devbox/users/quyanyi/playground/QATs/qat_launch.py \
  ...
  --devices 0,1,2,3,4,5,6,7 --nproc-per-node 8 --master-port 30276 \
  ...
  --anchor-ref-attn-kl-weight 0.00002 \
  --anchor-ref-warmup-epochs 50 \
  --anchor-ref-head-mode custom_subset:5:2,5:1,4:1,6:1,8:4 \
