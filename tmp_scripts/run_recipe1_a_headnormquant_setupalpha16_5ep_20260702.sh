...
EXP=recipe1_a_headnormquant_setupalpha16_5ep_20260702
...
PYTHONUNBUFFERED=1 python3 "$QATS/qat_launch.py" \
  ...
  --devices 0,1,2,3,4,5,6,7 --nproc-per-node 8 --master-port 30311 --model-type swin \
  ...
  --setup-alpha-batches 16 --trainable-policy head_norm_quant \
