...
EXP=swin_t_w4a4_stage2_partial_anchoronly_from50_to51_bsz128_kd_noema_20260701
LOG=/tmp/${EXP}.log
...
python3 /mlx_devbox/users/quyanyi/playground/QATs/qat_launch.py \
  ...
  --devices 0,1,2,3,4,5,6,7 --nproc-per-node 8 --master-port 30110 \
  ...
  --amp --amp-dtype bf16 \
  --train-scheme ema_ref_attn_kl --ref-update ema \
  --ref-attn-kl-weight 0.0 --anchor-ref-attn-kl-weight 0.001 --ref-attn-loss kl_ref \
  --ref-head-mode custom:5:2,10:14,5:1,4:1,9:10,6:1,8:4,8:9,11:18,11:4 \
  --ref-warmup-epochs 999 --anchor-ref-warmup-epochs 50 \
