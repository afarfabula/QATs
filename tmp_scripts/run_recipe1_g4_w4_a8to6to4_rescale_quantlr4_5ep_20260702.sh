...
EXP=recipe1_g4_w4_a8to6to4_rescale_quantlr4_5ep_20260702
...
PYTHONUNBUFFERED=1 python3 "$QATS/qat_launch.py" \
  ...
  --devices 0,1,2,3,4,5,6,7 --nproc-per-node 8 --master-port 30321 --model-type swin \
  ...
  --extra-arg=--progressive-bit-schedule --extra-arg=0:4:8,1:4:6,2:4:4 \
