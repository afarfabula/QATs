...
EXP="${EXP:-recipe2ep_m_fixed_qkr_noaug_scheduler1_quantlr4_binreg1e4_20260704}"
...
{
  echo "===== 2ep recipe M fixed-QKR no-aug scheduler1 quantlr4 binreg1e-4 $(date '+%F %T') ====="
  echo "QATS=${QATS}"
  echo "DATA=${DATA}"
  echo "OUT=${OUT}/${EXP}"
