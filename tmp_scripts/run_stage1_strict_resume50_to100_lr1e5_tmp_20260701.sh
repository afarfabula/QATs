...
EXP=swin_t_w4a4_stage1_strict_resume50_to100_lr1e5_tmp_20260701
...
PYTHONUNBUFFERED=1 python3 /mlx_devbox/users/quyanyi/playground/QATs/qat_launch.py \
  ...
  --devices 0,1,2,3,4,5,6,7 --nproc-per-node 8 --master-port 30142 \
  ...
  --epoch-checkpoint-interval 5 --checkpoint-hist 4 \
