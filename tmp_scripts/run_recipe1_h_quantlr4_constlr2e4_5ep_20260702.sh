...
EXP=recipe1_h_quantlr4_constlr2e4_5ep_20260702
...
PYTHONUNBUFFERED=1 python3 "$QATS/qat_launch.py" \
  ...
  --devices 0,1,2,3,4,5,6,7 --nproc-per-node 8 --master-port 30324 --model-type swin \
  ...
  --extra-arg=--epoch-lr-overrides --extra-arg=0:0.0002,1:0.0002,2:0.0002,3:0.0002,4:0.0002 \
