...
EXP=recipe1_aj_qssv1_pull005_q4_final10_5ep_20260703
...
PYTHONUNBUFFERED=1 python3 "$QATS/qat_launch.py" \
  ...
  --devices 0,1,2,3,4,5,6,7 --nproc-per-node 8 --master-port 30363 --model-type swin \
  ...
  --quant-lr-multiplier-epoch-overrides 4:10 \
