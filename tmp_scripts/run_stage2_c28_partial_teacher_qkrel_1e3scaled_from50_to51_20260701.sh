...
EXP=swin_t_w4a4_stage2_c28_partial_teacher_qkrel1000_from50_to51_20260701
LOG=/tmp/${EXP}.log
OUT=/tmp/qats_stage2_outputs/stage2_50to51_teacherqk_20260701
...
python3 /mlx_devbox/users/quyanyi/playground/QATs/qat_launch.py \
  ...
  --devices 0,1,2,3,4,5,6,7 --nproc-per-node 8 --master-port 30135 \
  ...
  --train-scheme ema_ref_attn_kl --ref-update prev_step --ref-attn-kl-weight 0.0 \
  --teacher-qk-rel-weight 1000 --teacher-qk-rel-warmup-epochs 50 \
