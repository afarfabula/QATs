...
EXP=recipe1_w6_prefeatrecon_midlate100_quantlr4_to8e4_5ep_20260703
...
PYTHONUNBUFFERED=1 python3 "$QATS/qat_launch.py" \
  ...
  --devices 0,1,2,3,4,5,6,7 --nproc-per-node 8 --master-port 30344 --model-type swin \
  ...
  --pre-qat-feature-recon-layers features.3.1,features.5.5,features.7.1 \
