...
EXP="${EXP:-recipe2ep_x_fixed_qkr_noaug_scheduler2_quantlr5_true_softkd_temp275_20260705}"
...
{
  echo "===== 2ep recipe X fixed-QKR no-aug scheduler2 quantlr5 true pure-soft-KD temp2.75 $(date '+%F %T') ====="
  echo "QATS=${QATS}"
  echo "DATA=${DATA}"
  echo "OUT=${OUT}/${EXP}"
