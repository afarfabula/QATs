...
EXP=swin_t_w4a4_stage2_partial_ce_weakref_from50_to51_bsz128_noema_20260701
LOG=/tmp/${EXP}.log
...
python3 /mlx_devbox/users/quyanyi/playground/QATs/qat_launch.py \
  ...
  --devices 0,1,2,3,4,5,6,7 --nproc-per-node 8 --master-port 30111 \
  --model-type swin \
  ...
  --pretrained --pretrained-initialized --quantized \
  --amp --amp-dtype bf16 \
