...
EXP="${EXP:-recipe3ep_e_featnorm_aug_fixed_qkr_softkd_t275_20260705}"
...
{
  echo "===== 3ep recipe E public-style W4A4-family feature-output + augmented teacher distill fixed-QKR soft-KD T=2.75 $(date '+%F %T') ====="
  echo "QATS=${QATS}"
  echo "DATA=${DATA}"
  echo "OUT=${OUT}/${EXP}"
