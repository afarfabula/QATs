...
EXP="${EXP:-ofq_100ep_fromscratch_teacher_sparse_attnkl_20260803}"
...
{
  echo "===== OFQ 100ep from-scratch teacher sparse attention KL $(date '+%F %T') ====="
  echo "QATS=${QATS}"
  echo "DATA=${DATA}"
  echo "OUT=${OUT}/${EXP}"
  echo "LOG=${LOG}"
