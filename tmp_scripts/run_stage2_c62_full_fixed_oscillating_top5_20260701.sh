...
EXP=swin_t_w4a4_stage2_c62_full_fixed_oscillating_top5_from50_to51_20260701
LOG=/tmp/${EXP}.log
...
python3 /mlx_devbox/users/quyanyi/playground/QATs/qat_launch.py \
  ...
  --devices 0,1,2,3,4,5,6,7 --nproc-per-node 8 --master-port 30186 \
  ...
  --ref-head-mode oscillating_top5 \
