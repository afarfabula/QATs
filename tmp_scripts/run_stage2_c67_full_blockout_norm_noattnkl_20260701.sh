...
EXP=swin_t_w4a4_stage2_c67_full_blockout_norm_noattnkl_from50_to51_20260701
LOG=/tmp/${EXP}.log
...
python3 /mlx_devbox/users/quyanyi/playground/QATs/qat_launch.py \
  ...
  --devices 0,1,2,3,4,5,6,7 --nproc-per-node 8 --master-port 30272 \
  ...
  --ref-attn-kl-weight 0.0 --ref-attn-loss kl_ref \
  --ref-head-mode dynamic_custom_top5:custom:5:2,10:14,5:1,4:1,9:10,6:1,8:4,8:9,11:18,11:4 \
  --ref-warmup-epochs 50 \
  --teacher-feature-output-weight 0.02 \
  --teacher-feature-output-loss norm_mse \
  --teacher-feature-output-layers features.1.1,features.3.1,features.5.5,features.7.1 \
  --teacher-feature-output-warmup-epochs 50 \
