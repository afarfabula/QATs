...
EXP="${EXP:-recipe_resume10_clean_lsq_noqkr_lsqaoq_thresholdonly_smoke2upd_20260708}" \
LOG="${LOG:-/mlx_devbox/users/quyanyi/playground/train_recipe_resume10_clean_lsq_noqkr_lsqaoq_thresholdonly_smoke2upd_20260708.log}" \
MASTER_PORT="${MASTER_PORT:-31163}" \
