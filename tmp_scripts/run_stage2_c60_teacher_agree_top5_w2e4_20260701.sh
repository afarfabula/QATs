...
EXP=swin_t_w4a4_stage2_c60_teacher_agree_top5_w2e4_from50_to51_20260701
LOG=/tmp/${EXP}.log
...
python3 /mlx_devbox/users/quyanyi/playground/QATs/qat_launch.py \
  ...
  --devices 0,1,2,3,4,5,6,7 --nproc-per-node 8 --master-port 30184 \
  ...
  --ref-attn-kl-weight 0.0002 --ref-attn-loss kl_ref \
  --ref-head-mode dynamic_teacher_agree_top5:custom:5:2,10:14,5:1,4:1,9:10,6:1,8:4,8:9,11:18,11:4 \
