...
EXP="${EXP:-recipe3ep_d_featnorm005_fixed_qkr_softkd_t275_20260705}"
...
{
  echo "===== 3ep recipe D public-style W4A4-family feature-output norm alignment fixed-QKR soft-KD T=2.75 $(date '+%F %T') ====="
  echo "QATS=${QATS}"
  echo "DATA=${DATA}"
  echo "OUT=${OUT}/${EXP}"
