...
EXP="${EXP:-recipe2ep_v_fixed_qkr_noaug_scheduler1_quantlr5_true_softkd_temp275_20260705}"
...
{
  echo "===== 2ep recipe V fixed-QKR no-aug scheduler1 quantlr5 true pure-soft-KD temp2.75 $(date '+%F %T') ====="
  echo "QATS=${QATS}"
  echo "DATA=${DATA}"
  echo "OUT=${OUT}/${EXP}"
