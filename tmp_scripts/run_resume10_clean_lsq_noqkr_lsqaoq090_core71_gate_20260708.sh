...
EXP="${EXP:-recipe_resume10_clean_lsq_noqkr_lsqaoq090_core71_gate_20260708}"
...
{
  echo "===== Clean LSQ no-QKR LSQ-AOQ090 core71 gate $(date '+%F %T') ====="
  echo "QATS=${QATS}"
  echo "DATA=${DATA}"
  echo "OUT=${OUT}/${EXP}"
  echo "RESUME=${RESUME}"
