...
EXP="${EXP:-recipe2ep_d_fixed_qkr_noaug_scheduler1_quantlr2_20260704}"
...
{
  echo "===== 2ep recipe D fixed-QKR no-aug scheduler1 quantlr2 $(date '+%F %T') ====="
  echo "QATS=${QATS}"
  echo "DATA=${DATA}"
  echo "OUT=${OUT}/${EXP}"
