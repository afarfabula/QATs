...
EXP="${EXP:-recipe2ep_o_fixed_qkr_noaug_scheduler1_quantlr4_softkd_20260704}"
...
{
  echo "===== 2ep recipe O fixed-QKR no-aug scheduler1 quantlr4 pure-soft-KD $(date '+%F %T') ====="
  echo "QATS=${QATS}"
  echo "DATA=${DATA}"
  echo "OUT=${OUT}/${EXP}"
