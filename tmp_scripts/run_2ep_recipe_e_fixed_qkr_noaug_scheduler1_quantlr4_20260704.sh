...
EXP="${EXP:-recipe2ep_e_fixed_qkr_noaug_scheduler1_quantlr4_20260704}"
...
{
  echo "===== 2ep recipe E fixed-QKR no-aug scheduler1 quantlr4 $(date '+%F %T') ====="
  echo "QATS=${QATS}"
  echo "DATA=${DATA}"
  echo "OUT=${OUT}/${EXP}"
