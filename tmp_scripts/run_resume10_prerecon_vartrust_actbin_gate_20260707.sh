...
EXP="${EXP:-recipe_resume10_prerecon_vartrust_actbin_gate_20260707}"
...
ACT_BIN_MARGIN_WEIGHT="${ACT_BIN_MARGIN_WEIGHT:-0.01}"
ACT_BIN_MARGIN_LAYERS="${ACT_BIN_MARGIN_LAYERS:-features.0.0,features.1.0,features.1.1,features.5.5,features.7.1}"
ACT_BIN_MARGIN_QUANTIZERS="${ACT_BIN_MARGIN_QUANTIZERS:-input_quant_fn,quant_x_4_qkv}"
ACT_BIN_MARGIN="${ACT_BIN_MARGIN:-0.08}"
ACT_BIN_MARGIN_MAX_ELEMENTS="${ACT_BIN_MARGIN_MAX_ELEMENTS:-32768}"
...
cmd=(
  ...
  --act-bin-margin-weight "${ACT_BIN_MARGIN_WEIGHT}"
  --act-bin-margin-layers "${ACT_BIN_MARGIN_LAYERS}"
  --act-bin-margin-quantizers "${ACT_BIN_MARGIN_QUANTIZERS}"
  --act-bin-margin "${ACT_BIN_MARGIN}"
  --act-bin-margin-max-elements "${ACT_BIN_MARGIN_MAX_ELEMENTS}"
...
{
  echo "===== Resume10 pre-QAT recon + variation trust + activation bin-margin gate $(date '+%F %T') ====="
  echo "QATS=${QATS}"
  echo "DATA=${DATA}"
  echo "OUT=${OUT}/${EXP}"
  echo "RESUME=${RESUME}"
  ...
  echo "ACT_BIN_MARGIN_WEIGHT=${ACT_BIN_MARGIN_WEIGHT}"
  echo "ACT_BIN_MARGIN_LAYERS=${ACT_BIN_MARGIN_LAYERS}"
  echo "ACT_BIN_MARGIN_QUANTIZERS=${ACT_BIN_MARGIN_QUANTIZERS}"
  echo "ACT_BIN_MARGIN=${ACT_BIN_MARGIN}"
  echo "ACT_BIN_MARGIN_MAX_ELEMENTS=${ACT_BIN_MARGIN_MAX_ELEMENTS}"
