...
EXP=swin_t_w4a4_stage2_anchor_prev_custom10_from50_to51_bsz128_kd_ema999_20260701
LOG=/tmp/${EXP}.log
...
python3 /mlx_devbox/users/quyanyi/playground/QATs/qat_launch.py \
  ...
  --teacher swin_t \
  --teacher-type swin \
  --teacher-checkpoint /home/tiger/.cache/torch/hub/checkpoints/swin_t-704ceda3.pth \
  --teacher-pretrained \
  --resume "${CKPT}" \
  --no-resume-opt \
  --epochs 51 \
  ...
  --ref-attn-kl-weight 0.0005 \
  --anchor-ref-attn-kl-weight 0.0005 \
