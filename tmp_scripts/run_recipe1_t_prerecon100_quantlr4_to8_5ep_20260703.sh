...
EXP=recipe1_t_prerecon100_quantlr4_to8_5ep_20260703
...
PYTHONUNBUFFERED=1 python3 "$QATS/qat_launch.py" \
  ...
  --devices 0,1,2,3,4,5,6,7 --nproc-per-node 8 --master-port 30336 --model-type swin \
  ...
  --pre-qat-recon-updates 100 \
  --pre-qat-recon-temperature 1.0 \
  --quant-lr-multiplier-epoch-overrides 3:8,4:8 \
