...
EXP="${EXP:-recipe_resume10_clean_lsq_noqkr_lsqaoq090_selectivemargin08_paramsinlate_after1800_gradmask_gate_20260708}" \
LOG="${LOG:-/mlx_devbox/users/quyanyi/playground/train_recipe_resume10_clean_lsq_noqkr_lsqaoq090_selectivemargin08_paramsinlate_after1800_gradmask_gate_20260708.log}" \
MASTER_PORT="${MASTER_PORT:-31352}" \
...
TRAINABLE_POLICY_UPDATE_OVERRIDES="${TRAINABLE_POLICY_UPDATE_OVERRIDES:-1800:params_in_layers}" \
