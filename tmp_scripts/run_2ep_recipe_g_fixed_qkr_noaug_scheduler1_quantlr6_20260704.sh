...
EXP="${EXP:-recipe2ep_g_fixed_qkr_noaug_scheduler1_quantlr6_20260704}"
...
{
  echo "===== 2ep recipe G fixed-QKR no-aug scheduler1 quantlr6 $(date '+%F %T') ====="
  echo "QATS=${QATS}"
  echo "DATA=${DATA}"
  echo "OUT=${OUT}/${EXP}"
