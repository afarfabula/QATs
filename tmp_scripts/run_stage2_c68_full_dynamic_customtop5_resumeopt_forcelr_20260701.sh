...
EXP=swin_t_w4a4_stage2_c68_full_dynamic_customtop5_resumeopt_forcelr_from50_to51_20260701
LOG=/tmp/${EXP}.log
...
python3 /mlx_devbox/users/quyanyi/playground/QATs/qat_launch.py \
  ...
  --devices 0,1,2,3,4,5,6,7 --nproc-per-node 8 --master-port 30273 \
  ...
  --resume "${CKPT}" --resume-opt-force-lr --epochs 51 --start-epoch 50 --scheduler-epochs 100 \
