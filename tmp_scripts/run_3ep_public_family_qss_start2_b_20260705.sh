...
EXP="${EXP:-recipe3ep_b_qss_start2_fixed_qkr_softkd_t275_20260705}"
...
{
  echo "===== 3ep recipe B public-style W4A4-family QSS-start2 fixed-QKR soft-KD T=2.75 $(date '+%F %T') ====="
  echo "QATS=${QATS}"
  echo "DATA=${DATA}"
  echo "OUT=${OUT}/${EXP}"
