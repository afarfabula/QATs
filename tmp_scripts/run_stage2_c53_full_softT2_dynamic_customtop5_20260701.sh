...
EXP=swin_t_w4a4_stage2_c53_full_softT2_dynamic_customtop5_from50_to51_20260701
LOG=/tmp/${EXP}.log
...
python3 /mlx_devbox/users/quyanyi/playground/QATs/qat_launch.py \
  ...
  --devices 0,1,2,3,4,5,6,7 --nproc-per-node 8 --master-port 30176 \
  ...
  --pretrained --pretrained-initialized --use-kd --kd-hard-and-soft 0 --quantized \
  --amp --amp-dtype bf16 \
  --teacher-soft-temperature 2.0 \
