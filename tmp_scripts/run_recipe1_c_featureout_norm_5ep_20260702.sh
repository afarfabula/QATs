...
EXP=recipe1_c_featureout_norm_w02_5ep_20260702
...
PYTHONUNBUFFERED=1 python3 "$QATS/qat_launch.py" \
  ...
  --devices 0,1,2,3,4,5,6,7 --nproc-per-node 8 --master-port 30312 --model-type swin \
  ...
  --teacher-feature-output-warmup-epochs 0 \
