...
EXP=gate_nonqkr_resume1_to10_20260704
TEACHER=/home/tiger/.cache/torch/hub/checkpoints/swin_t-704ceda3.pth
CKPT=/tmp/qat_recipe1_runs/gate_nonqkr_1ep_gt72_20260704/checkpoint-1.pth.tar
...
PYTHONUNBUFFERED=1 python3 "$QATS/qat_launch.py" \
  ...
  --devices 0,1,2,3,4,5,6,7 --nproc-per-node 8 --master-port 30412 --model-type swin \
