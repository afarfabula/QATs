...
EXP=recipe1_ae_qssv4_activation_slow_e3_pull005_q4_final8_5ep_20260703
...
PYTHONUNBUFFERED=1 python3 "$QATS/qat_launch.py" \
  ...
  --devices 0,1,2,3,4,5,6,7 --nproc-per-node 8 --master-port 30358 --model-type swin \
  ...
  --quant-slow-state-policy activation \
