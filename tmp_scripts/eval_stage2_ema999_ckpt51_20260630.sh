...
BASE=/tmp/qats_stage2_outputs/ofq_prevstep_attn_kl_headtop5_303opt_20260624
SRC=${BASE}/swin_t_w4a4_stage2_prevstep_custom10_from50_to51_bsz128_kd_ema999_20260630
CKPT=${SRC}/checkpoint-51.ema.pth.tar
EXP=eval_stage2_ema999_ckpt51_20260630
LOG=/tmp/${EXP}.log
ls -lh "${SRC}" || true
ls -lh "${CKPT}"
PYTHONUNBUFFERED=1 python3 "$QATS/qat_launch.py" \
  ...
  --devices 0,1,2,3,4,5,6,7 --nproc-per-node 8 --master-port 30012 --model-type swin \
