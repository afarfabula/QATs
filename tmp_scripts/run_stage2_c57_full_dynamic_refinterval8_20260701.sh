...
EXP=swin_t_w4a4_stage2_c57_full_dynamic_refinterval8_from50_to51_20260701
LOG=/tmp/${EXP}.log
...
python3 /mlx_devbox/users/quyanyi/playground/QATs/qat_launch.py \
  ...
  --devices 0,1,2,3,4,5,6,7 --nproc-per-node 8 --master-port 30181 \
  ...
  --amp --amp-dtype bf16 \
  --train-scheme ema_ref_attn_kl --ref-update prev_step --ref-update-interval 8 \
