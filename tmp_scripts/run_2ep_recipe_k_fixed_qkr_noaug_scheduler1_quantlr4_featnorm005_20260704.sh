...
EXP="${EXP:-recipe2ep_k_fixed_qkr_noaug_scheduler1_quantlr4_featnorm005_20260704}"
...
{
  echo "===== 2ep recipe K fixed-QKR no-aug scheduler1 quantlr4 featnorm005 $(date '+%F %T') ====="
  echo "QATS=${QATS}"
  echo "DATA=${DATA}"
  echo "OUT=${OUT}/${EXP}"
