...
EXP="${EXP:-recipe2ep_h_fixed_qkr_noaug_scheduler1_quantlr4_ema_20260704}"
...
{
  echo "===== 2ep recipe H fixed-QKR no-aug scheduler1 quantlr4 EMA $(date '+%F %T') ====="
  echo "QATS=${QATS}"
  echo "DATA=${DATA}"
  echo "OUT=${OUT}/${EXP}"
