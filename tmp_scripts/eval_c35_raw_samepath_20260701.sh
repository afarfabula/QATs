...
EXP=eval_c35_raw_samepath_20260701
CKPT=/tmp/qats_stage2_outputs/stage2_50to51_teacherref_20260701/swin_t_w4a4_stage2_c35_teacher_softonly_partial_ema999_from50_to51_20260701/checkpoint-51.pth.tar
...
PYTHONUNBUFFERED=1 python3 /mlx_devbox/users/quyanyi/playground/QATs/qat_launch.py \
  ...
  --devices 0,1,2,3,4,5,6,7 --nproc-per-node 8 --master-port 30150 \
  ...
  --extra-arg=--seed --extra-arg=42 2>&1 | tee /tmp/eval_c35_raw_samepath_20260701.log
