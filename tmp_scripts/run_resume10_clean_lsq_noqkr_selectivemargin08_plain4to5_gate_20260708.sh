...
EXP="${EXP:-recipe_resume10_clean_lsq_noqkr_selectivemargin08_plain4to5_gate_20260708}"
...
{
  echo "===== Clean LSQ no-QKR selective-margin08 plain 4-to-5 gate $(date '+%F %T') ====="
  echo "QATS=${QATS}"
  echo "DATA=${DATA}"
  echo "OUT=${OUT}/${EXP}"
  echo "RESUME=${RESUME}"
