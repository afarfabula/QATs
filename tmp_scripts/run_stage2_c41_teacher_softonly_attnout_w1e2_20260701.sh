...
EXP=swin_t_w4a4_stage2_c41_teacher_softonly_attnout_w1e2_from50_to51_20260701
LOG=/tmp/${EXP}.log
...
PYTHONUNBUFFERED=1 python3 /mlx_devbox/users/quyanyi/playground/QATs/qat_launch.py \
  ...
  --devices 0,1,2,3,4,5,6,7 --nproc-per-node 8 --master-port 30164 \
  ...
  --teacher-attn-output-weight 1e-2 \
  --teacher-attn-output-layers all \
  --teacher-attn-output-warmup-epochs 0 \
