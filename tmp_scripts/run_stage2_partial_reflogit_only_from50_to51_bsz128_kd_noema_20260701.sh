...
EXP=swin_t_w4a4_stage2_partial_reflogit_only_from50_to51_bsz128_kd_noema_20260701
LOG=/tmp/${EXP}.log
...
python3 /mlx_devbox/users/quyanyi/playground/QATs/qat_launch.py \
  ...
  --devices 0,1,2,3,4,5,6,7 --nproc-per-node 8 --master-port 30113 \
  ...
  --ref-attn-kl-weight 0.0 --ref-logit-kl-weight 0.05 --ref-logit-kl-temperature 2.0 \
