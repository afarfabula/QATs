...
EXP="${EXP:-recipe3ep_a_qsc_warmstart_fixed_qkr_softkd_t275_20260705}"
...
{
  echo "===== 3ep recipe A public-style W4A4-family QSC warm-start fixed-QKR soft-KD T=2.75 $(date '+%F %T') ====="
  echo "QATS=${QATS}"
  echo "DATA=${DATA}"
  echo "OUT=${OUT}/${EXP}"
