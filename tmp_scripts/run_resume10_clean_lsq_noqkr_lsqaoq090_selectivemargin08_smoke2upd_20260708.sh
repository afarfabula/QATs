...
EXP="${EXP:-recipe_resume10_clean_lsq_noqkr_lsqaoq090_selectivemargin08_smoke2upd_20260708}"
...
{
  echo "===== Clean LSQ no-QKR LSQ-AOQ090 selective-margin08 smoke2upd $(date '+%F %T') ====="
  echo "QATS=${QATS}"
  echo "DATA=${DATA}"
  echo "OUT=${OUT}/${EXP}"
  echo "RESUME=${RESUME}"
